...
export class LoginManager {
    ...
    public getClientSettingsSource(
    ...
    public onInit(httpClient: HttpClient, platform: PlatformLocation): Promise<LoginInitResult> {
        let isCallback = document.location.pathname == '/s/login-complete';
        return this.getClientSettingsSource(httpClient, platform).then((clientSettingsSource) => {
