...
namespace NTech.DocumentArchiveMigrator.DiskToAws
{
    public class RotatingLogFile
    {
        ...
        public RotatingLogFile(string folderName, string filenamePrefix, Func<DateTime> getNow, IFileSystem fileSystem, Func<string, string> formatLogEntry = null)
        {
        ...
        public RotatingLogFile(string folderName, string filenamePrefix, Func<string, string> formatLogEntry = null) : this(
            folderName, filenamePrefix,
            () => DateTime.Now, new RotatingLogFile.FileSystem(), formatLogEntry: formatLogEntry)
        {
