namespace NavigationTargetHelper {
    ...
    export enum NavigationTargetCode {
        Temp = "temp", //TODO: Remove when first real added. Just here to please the compiler
    }
    ...
    export function handleBackWithInitialDataDefaults(initialData: any, apiClient: NTechCustomerApi.ApiClient, $q: ng.IQService, context?: NavigationContext, defaultTarget?: NavigationTargetCode): ng.IPromise<void> {
        let t = createCodeOrUrlFromInitialData(initialData, context, defaultTarget)
        return handleBack(t, apiClient, $q, context)
    }

    export function handleBack(codeOrUrl: CodeOrUrl, apiClient: NTechCustomerApi.ApiClient, $q: ng.IQService, context: NavigationContext): ng.IPromise<void> {
