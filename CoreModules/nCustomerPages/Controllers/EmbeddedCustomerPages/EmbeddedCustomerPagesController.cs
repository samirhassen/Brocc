...
{
    public class EmbeddedCustomerPagesController : EmbeddedCustomerPagesControllerBase
    {
        /*        
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                name: "EmbeddedCustomerPages",
                url: "n/{*path}",
                defaults: new { controller = "EmbeddedCustomerPages", action = "Content" }
            );

            routes.MapRoute(
                name: "EmbeddedCustomerPagesForwardedApiCalls",
                url: "api/embedded-customerpages/proxy/{module}/{*path}",
                defaults: new { controller = "EmbeddedCustomerPages", action = "ForwardedApiCall" }
            );
        }

        [NTechApi]
        [Route("api/embedded-customerpages/download-document")]
        [HttpGet]
        ...
        [NTechApi]
        [Route("api/embedded-customerpages/fetch-config")]
        [AllowAnonymous]
        public ActionResult FetchConfig()
        {
            ...
            var config = new
            {
                ...
                LoginUrlPattern = NEnv.ServiceRegistry.External.ServiceUrl("nCustomerPages", "portal/navigate-with-login",
                    Tuple.Create("targetName", "___targetname___")).ToString(),
                LoginUrlWithCustomDataPattern = NEnv.ServiceRegistry.External.ServiceUrl("nCustomerPages", "portal/navigate-with-login",
        ...
        [NTechApi]
        [Route("api/embedded-customerpages/fetch-loggedin-user-details")]
        [HttpPost]
        ...
        private bool IsApiWhiteListedForProxying(string moduleName, string localPath)
        {
            ...
            if (moduleName.EqualsIgnoreCase("nPreCredit"))
            {
                return localPath.IsOneOfIgnoreCase(
                    "api/UnsecuredLoanStandard/CustomerPages/Fetch-Applications",
                    "api/UnsecuredLoanStandard/CustomerPages/Fetch-Application",
                    ...
                    "api/MortgageLoanStandard/CustomerPages/Answer-Kyc-Questions",
                    "api/UnsecuredLoanStandard/CustomerPages/Confirm-Bank-Accounts",
                    ...
                    "api/MortgageLoanStandard/CustomerPages/Fetch-Applications",
                    "api/MortgageLoanStandard/CustomerPages/Fetch-Application",
            ...
            {
                return localPath.IsOneOfIgnoreCase(
                    "api/LoanStandard/CustomerPages/Fetch-Loans",
            ...
            else if (moduleName.EqualsIgnoreCase("nCustomer"))
            {
