...
namespace nCustomerPages
{
    public static class NEnv
    {
        ...
        public static string TestingOverrideDateFile => IsProduction ? null : Opt("ntech.credit.testing.overridedatefile");

        public static bool IsCachingEnabled => (Opt("ntech.iscachingenabled") ?? "true").ToLowerInvariant().Trim() == "true";
        ...
        public static XDocument MortgageLoanKycQuestions
        {
            get
            {
                Func<XDocument> load = () => XDocuments.Load(
                        E.ClientResourceFile("ntech.customerpages.mortgageloankycquestionsfile", "MortgageLoan-KycQuestions.xml", true).FullName);
        ...
        public static NTechServiceRegistry ServiceRegistry
        {
            get
            {
                ...
                {
                    return E.ServiceRegistry;
                });
            }
        }

        public static bool IsCreditTokenAuthenticationModeEnabled => IsCreditOverviewActive && ClientCfg.IsFeatureEnabled("ntech.feature.customerpages.allowcredittokenlogin");

        public static bool IsCreditOverviewActive => ClientCfg.IsFeatureEnabled("ntech.feature.customerpages.creditoverview") && ServiceRegistry.ContainsService("nCredit");

        public static bool IsSavingsOverviewActive => ClientCfg.IsFeatureEnabled("ntech.feature.customerpages.savingsoverview") && ServiceRegistry.ContainsService("nSavings");

        public static bool IsBalanzia => ClientCfg.ClientName.Equals("balanzia", StringComparison.OrdinalIgnoreCase);

        public static bool IsSavingsApplicationActive => ClientCfg.IsFeatureEnabled("ntech.feature.customerpages.savingsapplication") && ServiceRegistry.ContainsService("nSavings");

        public static bool SkipInitialCompanyLoanScoring => Opt("ntech.customerpages.skipinitialcompanyloanscoring")?.ToLowerInvariant()?.Trim() == "true";
        ...
        public static bool IsEmbeddedMortageLoanCustomerPagesEnabled
        {
            get
            {
                ...
                return ClientCfg.IsFeatureEnabled("ntech.customerpages.embeddedmortageloancustomerpage") || (Opt("ntech.customerpages.embeddedmortageloancustomerpagesenabled") == "true");
            }
        }

        public static ClientConfiguration ClientCfg => NTechCache.WithCache("nCustomerPages.ClientCfg", TimeSpan.FromMinutes(15), () => ClientConfiguration.CreateUsingNTechEnvironment());
        public static IClientConfigurationCore ClientCfgCore =>
            NTechCache.WithCache("nCustomerPages.ClientCfgCore", TimeSpan.FromMinutes(15), () => ClientConfigurationCoreFactory.CreateUsingNTechEnvironment(E));
        ...
        public static Tuple<string, string> SystemUserUserNameAndPassword
        {
            get
            {
                if (!string.IsNullOrWhiteSpace(Opt("ntech.customerpages.systemuser.username")))
                    return Tuple.Create(Req("ntech.customerpages.systemuser.username"), Req("ntech.customerpages.systemuser.password"));
                else
        ...
        public static bool IsTranslationCacheDisabled => (Opt("ntech.customerpages.translation.cachedisabled") ?? "false") == "true";

        public static string TranslationOverrideEmbeddedFileWithThisLocalFilePath => Opt("ntech.customerpages.translation.overridefilepath");
        ...
        public static AffiliateTrackingModel.Settings SavingsAffiliateTrackingModelSettings
        {
            get
            {
                var f = E.StaticResourceFile("ntech.customerpages.savingsaffiliatetrackingfile", "savings-affiliatetracking.txt", false);
                if (f.Exists)
                {
        ...
        public static bool IsMortgageLoanProviderApiEnabled => ClientCfg.IsFeatureEnabled("ntech.feature.mortgageloan.customerpagesproviderapi");
        ...
        public static bool IsMortgageLoanProviderApiLoggingEnabled => (Opt("ntech.customerpages.isproviderapiloggingenabled") ?? "false")?.ToLowerInvariant() == "true";

        public static CivicRegNumberParser BaseCivicRegNumberParser => NTechCache.WithCache("BaseCivicRegNumberParser", TimeSpan.FromMinutes(5), () => new CivicRegNumberParser(ClientCfg.Country.BaseCountry));

        public static DirectoryInfo PdfTemplateFolder => E.ClientResourceDirectory("ntech.pdf.templatefolder", "PdfTemplates", true);

        public static FileInfo SavingsAccountWithdrawalAccountChangeAgreementFilePath => E.ClientResourceFile("ntech.customerpages.Savingsaccountwithdrawalcccountchangeagreementpdf", "SavingsAccountWithdrawalAccountChangeAgreement.pdf", true);

        public static DirectoryInfo AffiliatesFolder => E.ClientResourceDirectory("ntech.customerpages.affiliatesfolder", "Affiliates", true);
        ...
        public static bool IsCustomerPagesKycQuestionsEnabled => ClientCfg.IsFeatureEnabled("feature.customerpages.kyc");
        ...
        public static bool IsConsumerCreditStandardProviderApiLoggingEnabled => (Opt("ntech.customerpages.isconsumercreditstandardproviderapiloggingenabled") ?? "false")?.ToLowerInvariant() == "true";
