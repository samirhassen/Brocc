...
namespace NTech.Services.Infrastructure.Email
{
    public class SmtpEmailService : BaseNTechEmailService
    {
        ...
        public SmtpEmailService(DirectoryInfo templateFolder, IEmailRenderer renderer, NTechSimpleSettingsCore mailSettings, NEnv env) : base(templateFolder, renderer)
        {
