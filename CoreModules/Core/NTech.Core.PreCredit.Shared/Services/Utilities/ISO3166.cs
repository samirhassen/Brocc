...
namespace nPreCredit
{
    public static class ISO3166
    {
        ...
        public const string LanguageFinnish = "fi";
        public const string LanguageSwedish = "sv";

        public static ISO3166Country FromAlpha(string alpha, string language)
        {
            List<ISO3166Country> collection = BuildCollection(language);
            return collection.FirstOrDefault(p => (alpha.Length == 2 && p.Alpha2.ToUpper() == alpha.ToUpper()) || (alpha.Length == 3 && p.Alpha3.ToUpper() == alpha.ToUpper()));
        }
        public class DisplayCountry
        {
            public string code { get; set; }
            public string name { get; set; }
            public DisplayCountry(string code, string name)
            {
                this.code = code;
                this.name = name;
            }
        }
        public static IList<DisplayCountry> GetCountryCodesAndNames(string language)
        {
            return cache.Value.WithCache("GetCountryCodesAndNames: " + language, TimeSpan.FromHours(24), () =>
            {
                List<ISO3166Country> iso3166Countries = BuildCollection(language);
                List<DisplayCountry> countryCodesAndNames = new List<DisplayCountry>();
                foreach (ISO3166Country country in iso3166Countries)
                {
                    countryCodesAndNames.Add(new DisplayCountry(country.Alpha2, country.Name));
                }
        ...
        private static List<ISO3166Country> BuildCollection(string language)
        {
            return cache.Value.WithCache("ISO3166Country.BuildCollection-" + language, TimeSpan.FromHours(2), () => BuildCollectionI(language));
        }
        private static List<ISO3166Country> BuildCollectionI(string language)
        {
            ...
            if (language == LanguageEnglish)
            {
                ...
                collection.Add(new ISO3166Country("Côte dIvoire", "CI", "CIV", 384));
            ...
            else if (language == LanguageFinnish)
            {
                collection.Add(new ISO3166Country("Suomi", "FI", "FIN", 246));
                collection.Add(new ISO3166Country("Ruotsi", "SE", "SWE", 752));
                collection.Add(new ISO3166Country("Norja", "NO", "NOR", 578));
                collection.Add(new ISO3166Country("Tanska", "DK", "DNK", 208));
                collection.Add(new ISO3166Country("Afghanistan", "AF", "AFG", 4));
                collection.Add(new ISO3166Country("Åland", "AX", "ALA", 248));
                collection.Add(new ISO3166Country("Albania", "AL", "ALB", 8));
                collection.Add(new ISO3166Country("Algeria", "DZ", "DZA", 12));
                collection.Add(new ISO3166Country("American Samoa", "AS", "ASM", 16));
                collection.Add(new ISO3166Country("Andorra", "AD", "AND", 20));
            ...
            else if (language == LanguageSwedish)
            {
                collection.Add(new ISO3166Country("Finland", "FI", "FIN", 246));
                collection.Add(new ISO3166Country("Sverige", "SE", "SWE", 752));
                collection.Add(new ISO3166Country("Norge", "NO", "NOR", 578));
                collection.Add(new ISO3166Country("Danmark", "DK", "DNK", 208));
                collection.Add(new ISO3166Country("Afghanistan", "AF", "AFG", 4));
                collection.Add(new ISO3166Country("Åland", "AX", "ALA", 248));
                collection.Add(new ISO3166Country("Albania", "AL", "ALB", 8));
                collection.Add(new ISO3166Country("Algeria", "DZ", "DZA", 12));
                collection.Add(new ISO3166Country("Amerian Samoa", "AS", "ASM", 16));
                collection.Add(new ISO3166Country("Andorra", "AD", "AND", 20));
                collection.Add(new ISO3166Country("Angola", "AO", "AGO", 24));
                collection.Add(new ISO3166Country("Anguilla", "AI", "AIA", 660));
                collection.Add(new ISO3166Country("Antarctica", "AQ", "ATA", 10));
