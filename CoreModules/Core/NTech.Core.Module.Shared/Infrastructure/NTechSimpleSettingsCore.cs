...
{
    public class NTechSimpleSettingsCore
    {
        private readonly IDictionary<string, string> settings;
        private readonly string context;

        private NTechSimpleSettingsCore(IDictionary<string, string> settings, string context)
        {
        ...
        /// setting1 = 3
        /// </summary>
        public static NTechSimpleSettingsCore ParseSimpleSettingsFile(string filename, Encoding encoding = null, bool forceFileExistance = false)
        {
            ...
            return new NTechSimpleSettingsCore(d, $" simple settings file: '{filename}'");
        }

        public static string GetValueFromClientResourceFile(FileInfo metadataClientResourceFile, string value, string placeholderValue)
        {
            if (metadataClientResourceFile.Exists)
            {
                var settingsValueFromFile = ParseSimpleSettingsFile(metadataClientResourceFile.FullName, forceFileExistance: false);
        ...
        public static NTechSimpleSettingsCore ParseAppSettingsFile(string filename, bool forceFileExistance = false)
        {
            var d = ParseSettings(filename, fn =>
            {
            ...
            return new NTechSimpleSettingsCore(d, $" app settings file: '{filename}'");
        }

        public static NTechSimpleSettingsCore Create(Dictionary<string, string> values, string context = null)
        {
            var dd = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
            ...
            return new NTechSimpleSettingsCore(dd, context ?? $" in code settings");
        }
