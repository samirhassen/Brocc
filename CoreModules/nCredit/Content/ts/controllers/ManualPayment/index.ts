...
class ManualPaymentCtr {
    ...
    constructor(
        ...
        this.client = new NTechCreditApi.ApiClient(msg => toastr.error(msg), $http, $q)
    ...
    isDualityRequired: boolean

    client: NTechCreditApi.ApiClient
    isLoading: boolean
    ...
    KvKeySpace = 'CreditManualPaymentsV1'
