...
{
    public class NotifyCompanyCreditMethod : TypedWebserviceMethod<NotifyCompanyCreditMethod.Request, NotifyCompanyCreditMethod.Response>
    {
        public override string Path => "CompanyCredit/Notify";
        ...
        protected override Response DoExecuteTyped(NTechWebserviceMethodRequestContext requestContext, Request request)
        {
            ...
            var skipDeliveryExport = request.SkipDeliveryExport.GetValueOrDefault() || getSchedulerData("skipDeliveryExport") == "true";
            ...
            return CreditContext.RunWithExclusiveLock("ntech.scheduledjobs.createcompanyloannotifications",
                () =>
                    {
