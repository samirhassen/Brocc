...
{
    public class RemindMortgageLoanMethod : TypedWebserviceMethod<RemindMortgageLoanMethod.Request, RemindMortgageLoanMethod.Response>
    {
        public override string Path => "MortgageLoans/Remind";
        ...
        protected override Response DoExecuteTyped(NTechWebserviceMethodRequestContext requestContext, Request request)
        {
            ...
            var creditType = CreditType.MortgageLoan;
            ...
            return CreditContext.RunWithExclusiveLock("ntech.scheduledjobs.createmortgageloanreminders",
                    () =>
                    {
