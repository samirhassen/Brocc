...
namespace nCredit
{
    ...
    {
        public CreditContextExtended(INTechCurrentUserMetadata ntechCurrentUserMetadata, IClock clock)
        {
            this.CurrentUserId = ntechCurrentUserMetadata.UserId;
            this.Clock = clock;
            this.InformationMetadata = ntechCurrentUserMetadata.InformationMetadata;
        ...
        public IQueryable<AccountTransaction> TransactionsIncludingBusinessEventQueryable => Transactions.Include("BusinessEvent");
        ...
        public bool HasNewCreditAddedToContext(string creditNr) =>
            ChangeTracker.Entries<CreditHeader>().Any(x => x.State == System.Data.Entity.EntityState.Added && x.Entity.CreditNr == creditNr);
    }
}