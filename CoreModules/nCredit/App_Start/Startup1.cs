...
namespace nCredit.App_Start
{
    public class Startup1
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            LoginSetupSupport.SetupLogin(app, "nCredit", LoginSetupSupport.LoginMode.BothUsersAndApi, NEnv.IsProduction,
            ...
            ModelBinders.Binders.Add(typeof(decimal), new CommaAndDotDecimalModelBinder());
            ModelBinders.Binders.Add(typeof(decimal?), new CommaAndDotDecimalModelBinder());
