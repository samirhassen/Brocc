...
namespace nCredit.Controllers
{
    ...
    {
        private IDictionary<string, object> GetPending(CreditContext context)
        {
            ...
            var expectedTypes = new[] { BusinessEventType.NewCredit.ToString(), BusinessEventType.Repayment.ToString(), BusinessEventType.NewAdditionalLoan.ToString() };
