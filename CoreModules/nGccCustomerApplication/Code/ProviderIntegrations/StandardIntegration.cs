...
namespace nGccCustomerApplication.Code.ProviderIntegrations
{
    public class StandardIntegration : ProviderIntegrationBase
    {
        ...
        public static Controllers.ExternalProviderApplicationController.ExternalApplicationRequest TranslateToExternalRequest(StandardRequest request)
        {
            var result = new Controllers.ExternalProviderApplicationController.ExternalApplicationRequest
            {
                ExternalId = request?.externalId,
                Items = new List<Controllers.ExternalProviderApplicationController.ExternalApplicationRequest.Item>()
            };
        ...
        private static void AddItems<TSource>(TSource source, string groupName, List<Controllers.ExternalProviderApplicationController.ExternalApplicationRequest.Item> target)
        {
            Action<string, string> addItem = (name, value) => target.Add(new Controllers.ExternalProviderApplicationController.ExternalApplicationRequest.Item { Name = name, Value = value });
