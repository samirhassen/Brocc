...
namespace nGccCustomerApplication.Code.Clients
{
    public class SystemUserCustomerClient : AbstractSystemUserServiceClient, ISystemUserCustomerClient
    {
        ...
        public int GetCustomerId(NTech.Banking.CivicRegNumbers.ICivicRegNumber civicRegNr)
        {
        ...
        public NTech.Banking.CivicRegNumbers.ICivicRegNumber GetCivicRegNumber(int customerId)
        {
