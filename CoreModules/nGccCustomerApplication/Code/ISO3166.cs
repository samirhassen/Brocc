...
namespace nGccCustomerApplication
{
    ...
    public static class ISO3166
    {
        ...
        {
            return NTechCache.WithCache("GetCountryCodesAndNames: " + language, TimeSpan.FromHours(24), () =>
            {
        ...
        {
            return NTechCache.WithCache("ISO3166Country.BuildCollection-" + language, TimeSpan.FromHours(2), () => BuildCollectionI(language));
        }
