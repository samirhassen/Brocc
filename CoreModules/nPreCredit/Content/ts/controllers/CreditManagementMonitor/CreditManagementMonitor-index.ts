...
class CreditManagementMonitorCtr {
    static $inject = ['$scope', '$http', '$q', '$timeout', '$timeout', '$translate']
    constructor(
        $scope: any, //ng.IScope
        ...
        angular.forEach(initialData.providers, v => {
...
module CreditManagementMonitorNs {
}