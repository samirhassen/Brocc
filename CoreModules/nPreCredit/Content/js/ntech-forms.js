...
ntech.forms = (function () {
    ...
    return { isNullOrWhitespace: isNullOrWhitespace, isValidPositiveDecimal: isValidPositiveDecimal, replaceAll: replaceAll };
}());
...
ntech.angular = (function () {
    //Requires pascalprecht.translate
    function setupTranslation(app) {
        app.config(['$translateProvider', function ($translateProvider) {
                var tp = $translateProvider
                    .useUrlLoader(initialData.translation.translateUrl)
                    .registerAvailableLanguageKeys(['en', 'sv', 'fi'], {
                    'sv_*': 'sv',
                    'en_*': 'en',
                    'fi_*': 'fi',
                    '*': 'en'
                })
                    .translations(initialData.translation.uiLanguage, initialData.translation.translations[initialData.translation.uiLanguage]);
                if (initialData.translation.uiLanguage != 'en') {
                    tp.translations('en', initialData.translation.translations['en']);
                }
                tp.useSanitizeValueStrategy('escape')
                    .preferredLanguage(initialData.translation.uiLanguage)
                    .fallbackLanguage('en');
            }]);
    }
    return { setupTranslation: setupTranslation };
}());
