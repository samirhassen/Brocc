...
namespace nPreCredit.Code.Services.Bofink
{
    //TODO: Implement dynamically
    public class BofinkScoringDataSource : IPluginScoringProcessDataSource
    {
        private readonly PluginScoringProcessModelWithInternalHistory d;

        public BofinkScoringDataSource(PluginScoringProcessModelWithInternalHistory d)
        {
            this.d = d;
        }
