    ...
    : BusinessEventManagerBase(userId, informationMetadata, clock), IDisposable
{
    ...
    public static List<FixedAccountProduct> GetActiveFixedRates(ISavingsContext context) =>
        GetActiveFixedRatesQueryable(context).ToList();

    public static IQueryable<FixedAccountProduct> GetActiveFixedRatesQueryable(ISavingsContext context)
    {
        return context.FixedAccountProductQueryable
