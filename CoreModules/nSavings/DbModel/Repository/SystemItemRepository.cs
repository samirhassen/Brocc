...
namespace nSavings.DbModel.Repository
{
    ...
    {
        SavingsCoreSystemItemRepository repo;
        ...
        public DateTimeOffset? GetLatestChangeDate(SystemItemCode code, SavingsContext context) => repo.GetLatestChangeDate(code, context);
        public void SetTimestamp(SystemItemCode code, byte[] timestamp, SavingsContext context) => repo.SetTimestamp(code, timestamp, context);
        ...
        public void SetLong(SystemItemCode code, long value, SavingsContext context) => repo.SetLong(code, value, context);
