    ...
    public class SavingsAccountController : NController
    {
        ...
        public ActionResult Index(int? testUserId)
        {
            ViewBag.JsonInitialData = this.EncodeInitialData(new
            {
                ...
                savingsAccountLedgerTransactionDetailsUrl = Url.Action("SavingsAccountLedgerTransactionDetails", "ApiSavingsAccountDetails"),
                ...
                initialDataWithdrawalAccountUrl = Url.Action("InitialDataWithdrawalAccount", "ApiChangeWithdrawalAccount"),
                initialDataWithdrawalAccountChangeUrl = Url.Action("InitialDataWithdrawalAccountChange", "ApiChangeWithdrawalAccount"),
                previewWithdrawalAccountChangeUrl = Url.Action("PreviewWithdrawalAccountChange", "ApiChangeWithdrawalAccount"),
                initiateChangeWithdrawalAccountUrl = Url.Action("InitiateChangeWithdrawalAccount", "ApiChangeWithdrawalAccount"),
                fetchCustomerItemsUrl = Url.Action("FetchCustomerItems", "ApiSavingsAccountCustomerDetails"),
                commitChangeWithdrawalAccountUrl = Url.Action("CommitChangeWithdrawalAccount", "ApiChangeWithdrawalAccount"),
                cancelChangeWithdrawalAccountUrl = Url.Action("CancelChangeWithdrawalAccount", "ApiChangeWithdrawalAccount"),
